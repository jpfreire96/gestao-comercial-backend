...
$router->group(['prefix' => 'api'], function () use ($router) {
    ...
    $router->group(['prefix' => 'user'], function () use ($router) {
        $router->get('/', ['middleware' => ['cors', 'auth'], 'uses' => 'User@getAll']);
        $router->get('{id}', ['middleware' => ['cors', 'auth'], 'uses' => 'User@getOne']);
        $router->post('/', ['middleware' => ['cors', 'auth'], 'uses' => 'User@create']);
        $router->put('{id}', ['middleware' => ['cors', 'auth'], 'uses' => 'User@update']);
        $router->delete('{id}', ['middleware' => ['cors', 'auth'], 'uses' => 'User@delete']);
    });
